...
from utils.eval_time import EvalTime
...
class PARQDecoder(torch.nn.Module):
    ...
    def __init__(
        ...
        # conf_thresh: float,
        # mean_size_path: str = None,
        # eval_type: str = "f1",
        # enable_nms: bool = False,
        # transformer: torch.nn.Module = None,
        # bg_cls_weight: float = 0.1,
        # share_mlp_heads: bool = True,
        # for_vis: bool = False,
        # track_scale: List = [-1.5, 1.5, -2, 1, 0, 2],
    ):
    ...
    def parse_target(
        ...
        for i in range(bs):
            ...
            size = bb3_target_i.bb3_diagonal
    ...
    def loss(
        ...
        *argv,
        ...
        for out_dict in out_dict_list:
            ...
            ET("parse target and match ends")
            # compute loss
            for i in range(bs):
