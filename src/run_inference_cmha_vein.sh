...
CUDA_VISIBLE_DEVICES=$5 python src/train_net.py\
    ...
    --eval-only\
    MODEL.WEIGHTS $3\
    DATA.DIR.VAL.SCAN_DIR "${ROOT_DATA}/cmha/crop_0.4"\
    DATA.DIR.VAL.ANNOTATION_FILE "./labels/gt/internal_test_crop_0.4.csv"\
    DATA.DIR.VAL.VESSEL_DIR "${ROOT_DATA}/cmha/crop_0.4_vessel_edt_comp"\
    DATA.DIR.VAL.CVS_DIR "${ROOT_DATA}/cmha/vein_mask_edt_comp"
